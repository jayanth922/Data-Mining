This Task is about using Auto EDA tool, Pandas Profiling to quickly get an idea of data. It only needs a single command and generates a neat report of the data.
